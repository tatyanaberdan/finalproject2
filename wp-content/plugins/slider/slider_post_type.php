...
/*
Plugin Name: Slides
Plugin URI: http://tatyanaberdan.com/slides
Description: Slider for travel photos
...
//            'menu_icon'         => get_template_directory_uri() . '/icon.png',
    ...
    function wptuts_slidelink_2_save($post_id) {
        ...
        // verify nonce
        if ( !isset( $_POST['wptuts_slidelink_2_meta_box_nonce'] ) || !wp_verify_nonce( $_POST['wptuts_slidelink_2_meta_box_nonce'], basename( __FILE__ ) ) )
        return $post_id;
