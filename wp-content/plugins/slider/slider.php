...
// Enqueue Flexslider Files
    ...
    function wptuts_slider_scripts() {
        ...
        wp_enqueue_style( 'flex-style', get_template_directory_uri() . 'slider/flexslider.css' );
 
        wp_enqueue_script( 'flex-script', get_template_directory_uri() .  'slider/jquery.flexslider-min.js', array( 'jquery' ), false, true );
    }
